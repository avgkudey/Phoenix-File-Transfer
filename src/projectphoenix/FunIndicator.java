...
public class FunIndicator extends Region {
    ...
    public FunIndicator() {
        ...
        fromColor       = new ObjectPropertyBase<Color>(Color.rgb(255, 166, 9)) {
            @Override public Object getBean() { return FunIndicator.this; }
            @Override public String getName() { return "fromColor"; }
        };
        toColor         = new ObjectPropertyBase<Color>(Color.rgb(9, 255, 166)) {
            @Override public Object getBean() { return FunIndicator.this; }
            @Override public String getName() { return "toColor"; }
        };
    ...
    private void initTimeline() {
        ...
        KeyFrame kf1          = new KeyFrame(Duration.ZERO, colorKvBegin, arc1KvBegin, arc2KvBegin, arc3KvBegin, arc4KvBegin, arc5KvBegin, arc6KvBegin, arc7KvBegin);
        KeyFrame kf2          = new KeyFrame(Duration.millis(3000), colorKvMid);
        KeyFrame kf3          = new KeyFrame(Duration.millis(6000), colorKvEnd, arc1KvEnd, arc2KvEnd, arc3KvEnd, arc4KvEnd, arc5KvEnd, arc6KvEnd, arc7KvEnd);
    ...
    // ******************** Methods *******************************************
    public Color getFromColor() { return fromColor.get(); }
    public void setFromColor(final Color COLOR) { fromColor.set(COLOR); }
    public ObjectProperty<Color> fromColorProperty() { return fromColor; }

    public Color getToColor() { return toColor.get(); }
    public void setToColor(final Color COLOR) { toColor.set(COLOR); }
    public ObjectProperty<Color> toColorProperty() { return toColor; }
